...
void t_ParticleSaver::Export(ParticleSystem& system, const char* path)
{
	...
	std::string class_name = std::string(path).substr(std::string(path).find_last_of("/\\") + 1);
	...
	constructor_params << class_name << "::" << class_name << "()\n"
	...
	std::string particle_code =
		...
		"}\n"
		"\n"
		"bool " + class_name + "::b_LoadTexture(const char* filename)\n"
		"{\n"
		...
		"}\n"
		"\n"
		"void " + class_name + "::SetUseTexture(bool use)\n"
		"{\n"
		"\tb_UseTexture = use && (particle_texture.id > 0);\n"
		"}\n"
		"\n"
		"bool " + class_name + "::b_IsUsingTexture() const\n"
		"{\n"
		"\treturn b_UseTexture && (particle_texture.id > 0);\n"
		"}\n"
		"\n"
		"Vector2 " + class_name + "::GetEmissionPoint()\n"
		"{\n"
		...
		"}\n"
		"\n"
		"void " + class_name + "::DrawEmitterShape() const\n"
		"{\n"
		...
		"}\n"
		"\n"
		"int " + class_name + "::GetParticleCount() const\n"
		"{\n"
